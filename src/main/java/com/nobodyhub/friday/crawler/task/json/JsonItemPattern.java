...
import com.nobodyhub.friday.crawler.task.json.selector.JsonVideoItemPattern;
import lombok.EqualsAndHashCode;

import java.util.List;

import static com.nobodyhub.friday.crawler.task.common.item.Item.JSON_VALUE;
